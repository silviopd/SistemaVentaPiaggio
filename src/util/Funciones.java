...
public class Funciones {
    public static final String NOMBRE_SOFTWARE = "Sistema de Ventas - Piaggio ";
    public static String USUARIO_LOGUEADO;
    public static String TIPO_USUARIO_LOGUEADO;
    public static String DNI_LOGUEADO;
    public static int CODIGO_USUARIO_LOGUEADO;
...
public static void aceptaTodosCaracteres(KeyEvent evt, JTextField objTexto, int numeroCaracteres){
 ...
 public static void soloLetras(KeyEvent evt, JTextField objTexto, int numeroCaracteres){
    ...
    public static void soloNumerosyLetras(KeyEvent evt, JTextField objTexto, int numeroCaracteres){
      char car = evt.getKeyChar();
    ...
    public static void soloNumerosyLetrasMinusculas(KeyEvent evt, JTextField objTexto, int numeroCaracteres){
      char car = evt.getKeyChar();
     ...
     if (numeroCaracteres > 0){
       ...
       public static void soloNumerosNumeralyAsterisco(KeyEvent evt, JTextField objTexto, int numeroCaracteres){
      char car = evt.getKeyChar();
