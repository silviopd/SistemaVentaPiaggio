...
public class Reportes extends Conexion {
    ...
    public JasperViewer reporteInterno(String archivoReporte,Map<String,Object> parametros) throws Exception {
        try {
            ...
            System.out.println("ruta:" + RUTA_REPORTES+ archivoReporte);
